        ...
        <div class="row justify-content-center">
          <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="text-center">
              ...
              <div class="counter font-26 font-weight-800 text-primary m-b5" style="font-size: x-large">
                <?php echo $rowCount1; ?>
              </div>
    ...
    <div style="padding-left: 70px">
      <div class="contactbody">
        ...
        <div class="cdisplay" style="margin-top: 30px">
          <i class="fa-solid fa-phone" style="margin-left: 0%; margin-right: 2%; margin-top: 0px"></i>
          <h6>+91 6352900593</h6>
        </div>
        <div class="cdisplay">
          <i class="fa-solid fa-phone" style="margin-left: 0%; margin-right: 2%"></i>
          <h6>+91 9157873567</h6>
        </div>
        <div class="cdisplay">
          <i class="fas fa-envelope" style="margin-left: 0%; margin-right: 2%"></i>
